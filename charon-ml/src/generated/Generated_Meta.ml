...
(** Meta information about a piece of code (block, statement, etc.) *) and  span = { data :  span_data  (** The source code span.
     ...
     *);generated_from_span : ( span_data) option  (** Where the code actually comes from, in case of macro expansion/inlining/etc. *) }

(** Span information *) and  span_data = { file :  file_id  ;beg_loc :  loc  ;end_loc :  loc   }
[@@deriving show, ord, eq]
