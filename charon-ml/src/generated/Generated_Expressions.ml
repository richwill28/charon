 ...
 *) and  projection_elem = 
 ...
 | PtrMetadata (** A built-in pointer (a reference, raw pointer, or [Box]) in Rust is always a fat pointer: it
 ...
 *) and  rvalue = 
 ...
 | RvRef of  place * borrow_kind * operand *(( view_field) list) option  (** Takes a reference to the given place.
 ...
 | RawPtr of  place * ref_kind * operand  (** Takes a raw pointer with the given mutability to the given place. This is generated by
 ...
 | Len of  place * ty *( const_generic) option  (** Length of a place of type [[T]] or [[T; N]]. This applies to the place itself, not to a
...
(** Unary operation *) and  unop = 
 ...
 and  view_field = { path : ( string) list  ;kind :  borrow_kind   }
